...
INSERT INTO question (created_date, question_id, user_id, title, content, visit_count) VALUES ('2020-08-26 02:35:31', 1, 100, '가비지 컬렉션이란 무엇인가','GC를 어느정도 까지 알아야할까요?', 100);
INSERT INTO question (created_date, question_id, user_id, title, content, visit_count) VALUES ('2020-08-26 02:35:32', 2, 54, 'PUT과 PATCH의 차이','PUT과 PATCH가 둘다 수정을 위한 HTTP METHOD로 알고 있는데, 어떤 차이가 있나요?', 30);
INSERT INTO question (created_date, question_id, user_id, title, content, visit_count) VALUES ('2020-08-26 02:35:33', 3, 100, 'Rest API','PUT과 PATCH가 둘다 수정을 위한 HTTP METHOD로 알고 있는데, 어떤 차이가 있나요?', 43);
INSERT INTO question (created_date, question_id, user_id, title, content, visit_count) VALUES ('2020-08-26 02:35:34', 4, 54, 'HTTP vs HTTPS','PUT과 PATCH가 둘다 수정을 위한 HTTP METHOD로 알고 있는데, 어떤 차이가 있나요?', 111);
INSERT INTO question (created_date, question_id, user_id, title, content, visit_count) VALUES ('2020-08-26 02:35:35', 5, 100, '싱글톤 패턴 예시','PUT과 PATCH가 둘다 수정을 위한 HTTP METHOD로 알고 있는데, 어떤 차이가 있나요?', 12);
INSERT INTO question (created_date, question_id, user_id, title, content, visit_count) VALUES ('2020-08-26 02:35:36', 6, 54, '무한 스크롤','PUT과 PATCH가 둘다 수정을 위한 HTTP METHOD로 알고 있는데, 어떤 차이가 있나요?', 54);
INSERT INTO question (created_date, question_id, user_id, title, content, visit_count) VALUES ('2020-08-26 02:35:37', 7, 100, '코로나 싫어요','PUT과 PATCH가 둘다 수정을 위한 HTTP METHOD로 알고 있는데, 어떤 차이가 있나요?', 66);
INSERT INTO question (created_date, question_id, user_id, title, content, visit_count) VALUES ('2020-08-26 02:35:38', 8, 54, 'this is question','PUT과 PATCH가 둘다 수정을 위한 HTTP METHOD로 알고 있는데, 어떤 차이가 있나요?', 17);
INSERT INTO question (created_date, question_id, user_id, title, content, visit_count) VALUES ('2020-08-26 02:35:39', 9, 100, 'JVM 작동원리','PUT과 PATCH가 둘다 수정을 위한 HTTP METHOD로 알고 있는데, 어떤 차이가 있나요?', 31);
INSERT INTO question (created_date, question_id, user_id, title, content, visit_count) VALUES ('2020-08-26 02:35:40', 10, 54, 'websocket에 대해 알아야할까요','PUT과 PATCH가 둘다 수정을 위한 HTTP METHOD로 알고 있는데, 어떤 차이가 있나요?', 29);
INSERT INTO question (created_date, question_id, user_id, title, content, visit_count) VALUES ('2020-08-26 02:35:41', 11, 100, 'Querydsl은 무엇인가요?','PUT과 PATCH가 둘다 수정을 위한 HTTP METHOD로 알고 있는데, 어떤 차이가 있나요?', 99);
